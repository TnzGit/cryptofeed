    ...
    def _connect_rest(self):
        ...
        for chan in set(self.subscription):
            if chan == 'open_interest':
                ...
                ret.append((HTTPPoll(addrs, self.id, delay=300.0, sleep=self.open_interest_interval, proxy=self.http_proxy), self.subscribe, self.message_handler, self.authenticate))
        return ret
